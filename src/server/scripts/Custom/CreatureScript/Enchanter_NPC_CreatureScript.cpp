	...
	bool OnGossipSelect(Player* player, Creature* creature, uint32 sender, uint32 action)
	{
		...
		if (sender == GOSSIP_SENDER_MAIN)
		{
			...
			case 2: // Off-Hand Weapon.
				...
				{
                    player->ADD_GOSSIP_ITEM(5, "Titanium Weapon Chain.", GOSSIP_SENDER_MAIN, 19);
			...
			case 3: // Two-Handed Weapon.
				...
				{
                    player->ADD_GOSSIP_ITEM(5, "Titanium Weapon Chain.", GOSSIP_SENDER_MAIN, 20);
					player->ADD_GOSSIP_ITEM(5, "Berserking", GOSSIP_SENDER_MAIN, 104);
			...
			case 14: // Legs.
				...
				{
					player->ADD_GOSSIP_ITEM(5, "+40 Reslience, +28 Stamina.", GOSSIP_SENDER_MAIN, 184);
					player->ADD_GOSSIP_ITEM(5, "+55 Stamina, +22 Agility.", GOSSIP_SENDER_MAIN, 185);
					player->ADD_GOSSIP_ITEM(5, "+75 Attack Power, +22 Crit.", GOSSIP_SENDER_MAIN, 186);
					player->ADD_GOSSIP_ITEM(5, "+50 Spell Power, +20 Spirit.", GOSSIP_SENDER_MAIN, 187);
					player->ADD_GOSSIP_ITEM(5, "+50 Spell Power, +30 Stamina.", GOSSIP_SENDER_MAIN, 188);
					player->ADD_GOSSIP_ITEM(7, "Back!", GOSSIP_SENDER_MAIN, 300);
					player->PlayerTalkClass->SendGossipMenu(1, creature->GetGUID());
					return true;
				}
            ...
            case 19: // Titanium Weapon Chain.
                ...
                Enchant(player, player->GetItemByPos(INVENTORY_SLOT_BAG_0, EQUIPMENT_SLOT_OFFHAND), 3365);
                player->PlayerTalkClass->SendCloseGossip();
                break;

            case 20: // Titanium Weapon Chain.
                item = player->GetItemByPos(INVENTORY_SLOT_BAG_0, EQUIPMENT_SLOT_MAINHAND);
