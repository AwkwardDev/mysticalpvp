...
class Beastmaster_NPC_CreatureScript : public CreatureScript
    {
    public:
        Beastmaster_NPC_CreatureScript() : CreatureScript("Beastmaster_NPC_CreatureScript") { }
    ...
    {
        new Beastmaster_NPC_CreatureScript;
    }
